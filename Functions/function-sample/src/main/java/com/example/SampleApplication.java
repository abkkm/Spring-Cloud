...
public class SampleApplication {
	...
	//localhost:8080/lowercase/Eugenio Garcia
	@Bean
	...
	public Function<String, String> compiledUppercase(
		...
		final String lambda = "s -> s.toUpperCase()";
		final LambdaCompilingFunction<String, String> function = new LambdaCompilingFunction<>(
	...
	public Function<Flux<String>, Flux<String>> compiledLowercase(
		...
		final String lambda = "f->f.map(o->o.toString().toLowerCase())";
