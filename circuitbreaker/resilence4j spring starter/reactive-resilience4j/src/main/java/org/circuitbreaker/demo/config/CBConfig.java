...
public class CBConfig {
	...
	@Bean
	public Customizer<ReactiveResilience4JCircuitBreakerFactory> defaultCBCustomizer() {
	...
	@Bean
	public Customizer<ReactiveResilience4JCircuitBreakerFactory> slowCBCustomizer() {
		return factory -> {
			factory.configure(
					builder -> builder
			...
			factory.addCircuitBreakerCustomizer(circuitBreaker -> circuitBreaker.getEventPublisher()
					...
					.onSuccess(e -> log.info("success")),"normalflux");
		};
	}
